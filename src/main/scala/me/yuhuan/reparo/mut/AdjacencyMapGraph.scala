package me.yuhuan.reparo.mut

import me.yuhuan.reparo._
import me.yuhuan.reparo.builder.GraphBuilder
import me.yuhuan.reparo.factory.GraphFactory
...
class AdjacencyMapGraph[K, N, E] private(val nodeMap: mutable.HashMap[K, N], val edgeMap: mutable.HashMap[K, mutable.ListMap[K, E]])
  extends KeyMutableGraph[K, N, E] { outer ⇒
  ...
  def edgeKeys = {
    ...
    edgeMap.toIterable.flatMap(p ⇒ p._2.toIterable.map(q ⇒ p._1 → q._1))
  }
